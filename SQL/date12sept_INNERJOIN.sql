create table students(id int primary key identity,admission_no varchar(30) not null,
first_name varchar(30)not null,last_name varchar(30) not null,age int,city varchar(30)not null)

create table fee(admission_no varchar(30) not null,course varchar(30) not null,amount_paid int)
